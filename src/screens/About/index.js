      ...
      <main className='main-container'>
        ...
        <article className='main-contant'>
          <div className="info-top">
            ...
            <div className="imgs">
              ...
              <img src={Logo} alt="logo-marca" className='logoMarca' />
              <img src={Autor} alt="logo-marca" className='autor' />
            </div>
        ...
        <div className="info">
          <div className="paragrafo">
            <p>Renato Gonda é poeta, artista plástico e <i>designer visual</i> e de objetos, possuindo licenciatura em artes (educação
